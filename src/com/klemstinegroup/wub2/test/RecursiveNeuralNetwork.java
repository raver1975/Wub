...
public class RecursiveNeuralNetwork {
    ...
    public static JFrame frame = new JFrame(RecursiveNeuralNetwork.class.toString());
    ...
    public static final int numClusters = 64;
    ...
    static double temperature = .01d;
    static int bottleneckSize = 10; //one-hot input is squeezed through this
    static int hiddenDimension = 400;
