...
//        frame.setVisible(true);
                ...
                HashMap<SegmentSong, SegmentSong> map1 = makeMap(totsegm - Settings.decreaseClustersBy);
                HashMap<SegmentSong, SegmentSong> map2 = makeMap((int) (totsegm * Settings.segmentsKept));
...
//                    System.out.println(trans);
                    AudioInterval ai2 = tempSong[0].getAudioInterval(tempSong[0].analysis.getSegments().get(trans.segment),tempSong[0].number,startNode[0].segment);
